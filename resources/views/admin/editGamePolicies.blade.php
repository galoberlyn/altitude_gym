      ...
      <div class="content-wrapper">
		...
		@include('admin.inc.message')
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            @include('admin.inc.message')
             <h2 class="content-header-title blue-grey"><h2 class="content-header-title teal"><i class="icon-ios-game-controller-b"></i>   Edit Gamification Policy</h2>
          </div>
        ...
        <div class="content-body"><!-- Description --><section id="description" class="card">
    <div class="card-body collapse in">
        <div class="card-block">
         {!! Form::open ([ 'action' => ['AdminGamePoliciesController@update', $policy->id], 'method' => 'POST']) !!}
            <div class="tab-content px-1 pt-1">
              ...
              <div class="">
                ...
                <div class="form-group">
								...
								{{Form::select('category', array('Gamification' => 'Gamification'), $policy->category, ['class' => 'round border-warning'])}}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="position-relative has-icon-left">
										{{Form::select('type', array('Point' => 'Points', 'Leveling' => 'Leveling',  'Badges' => 'Badges'),$policy->type, ['class' => 'form-control round border-success'])}}
										<div class="form-control-position">
