...
@section('content')  
<title>Altitude Gym | Dashboard</title>
          ...
          <div class="col-xl-12 col-lg-12">
              <div class="row">
                <div class="col-xs-8">
                    ...
                    @endforeach
                    @foreach ($act_members as $active_member)
                    <div class ="card-group">
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body blue-grey text-xs-left">
                                        ...
                                        <span><a href="/memberLog"> View.. </a></span> 
                                    </div>
                                    <div class="media-right media-middle">
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body orange text-xs-left">
                                        ...
                                        <a href="/gamificationPolicies"> View.. </a> 
                                    </div>
                                    <div class="media-right media-middle">
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body yellow text-xs-left">
                                        ...
                                        <span> <a href="/gymPolicies"> View.. </a> </span>
                            ...
                            <div id="carousel-interval" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action media">
                                                ...
                                                <div class="media-right">
                                                    <span class="tag tag-default tag-pill bg-info float-xs-right" style="width: 40px; height: 25px;"><h6>lvl {{$beginners->level}}</h6></span>
                                                </div>
                                            </a>
                                            @endforeach
                                            @else
                                    ...
                                    <div class="card-body">
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action media">
                                                ...
                                                <div class="media-right">
                                                    <span class="tag tag-default tag-pill bg-success float-xs-right" style="width: 40px; height: 25px;"><h6>lvl {{$intermediates->level}}</h6></span>
                                                </div>
                                            </a>
                                            @endforeach
                                            @else
                                    ...
                                    <div class="card-body">
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action media">
                                                ...
                                                <div class="media-right">
                                                    <span class="tag tag-default tag-pill bg-warning float-xs-right" style="width: 40px; height: 25px;"><h6>lvl {{$advances->level}}</h6></span>
                                                </div>
                                            </a>
                                            @endforeach
                                            @else
                                ...
                                <div class="carousel-item">
                                    <div class="card-header bg-primary card-inverse">
                                        <h5 class="card-title">Top 10 Athletes of the Month</h5>
                                        <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <span class="avatar">
                                    ...
                                    <div class="card-body">
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action media">
                                                ...
                                                <div class="media-right">
                                                    <span class="tag tag-default tag-pill bg-primary float-xs-right" style="width: 40px; height: 25px;"><h6>lvl {{$recentawards->level}}</h6></span>
                                                </div>
                                            </a>
                                            @endforeach
                                            @else
